...
DECTECTIONDLL_API void do_nms_sort(detection *dets, int total, int classes, float thresh);
DECTECTIONDLL_API void do_nms_obj(detection *dets, int total, int classes, float thresh);
